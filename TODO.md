...
- [x] Add logging configuration to CLI — Currently only logs to file; add optional --verbose/--quiet flags for user feedback.
...
- [x] Refactor extract_cbz_and_rename_images — Function is long (50+ lines); split into smaller helpers.
- [x] Add type hints to all functions — Currently partial; complete coverage for better IDE support.
